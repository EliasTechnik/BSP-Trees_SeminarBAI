...
uses
  ...
  ComCtrls, unit_quadtree, BGRABitmap, BGRABitmapTypes;
...
procedure Tformmain.saveGraph;
var bm:tbgrabitmap;
begin
  bm:=tbgrabitmap.Create((t.get_depth(0)-1)*4*(15+4),t.get_depth(0)*(15+10));
  bm.Canvas.Pen.Color:=rgbtocolor(0,0,0);
  bm.canvas.pen.style:=pssolid;
  t.paintGraph(c,0,0,15,10,2);
end;
